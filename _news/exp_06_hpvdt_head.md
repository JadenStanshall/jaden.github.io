...
<div style="display: flex; align-items: flex-start; gap: 15px; margin-bottom: 20px;">
  <img src="{{ '/assets/img/hpvdt-logo.png' | relative_url }}" alt="HPVDT" style="width: 80px; height: 80px; object-fit: contain;">
  <div>
    <h5 style="margin: 0;">Head of Electronics @ <a href="https://hpvdt.ca/" target="_blank">UofT Human Powered Vehicles Design Team</a></h5>
